...
If the engagement context contains priorQuestions, this agent already asked them on a previous run. Do not ask them again when the user instruction or a userClarification answers or waives them.
...
If the engagement context contains priorQuestions, this agent already asked them. Do not return that same question list when the user instruction or a userClarification answers or waives them. Put remaining uncertainty in gaps and assumptions, and fill the artifact from the saved upstream evidence.
